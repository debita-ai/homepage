      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            >
              <motion.li variants={itemMotion}>
                <a href="https://web.whatsapp.com/send?l=pt_BR&phone=19182384714" className="hover:text-[#E85A27] transition-colors flex items-center" target="_blank" rel="noopener noreferrer">
              ...
              <motion.li className="flex items-center" variants={itemMotion}>
                ...
                paulooliveiralacerda@gmail.com
              </motion.li>
